...
class Coches:
    ...
    def __init__(self,color,marca,modelo,velocidad,caballaje,plazas):
        ...
        self.plazas=plazas
#el encapusilamiento en pyhton tanmbien es llamdo visibilidad, y practicamente se puede hacer que un atributo  y u o un metodo sea publico o privados
    #Metodos o acciones o funciones que hace el objeto 
#atributo publico
atributo_publco="soy un atributo publico"

__atributo_privado="soy un atributo privado"

def getatributoprivado(self):
      return __atributo_privado
#metodo privado
def _MetodoPrivado(self):
      print("soy un metodo privado")

#nota 2 para utlizar un atributo es nesecario hacer lo dentero de un meotdo publico
